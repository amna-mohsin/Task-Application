...
function CreateToDoItems() {
  if (todoValue.value === "") {
    ...
    const todoItems = `<div title="Hit Double Click and Complete" ondblclick="CompletedToDoItems(this)">${todoValue.value}</div><div>
                    <img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="Assets/edit.webp" />
                    <img class="delete todo-controls" onclick="DeleteToDoItems(this)" src="Assets/delete.jpg" /></div></div>`;
